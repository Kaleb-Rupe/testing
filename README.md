...
npx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-testing
# created an pnpm based project
pnpx create-solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-testing
# created an yarn based project
yarn create solana-dapp --template gh:solana-developers/solana-templates/templates/legacy-testing
```
...
cd solana-templates/legacy-testing
```
